let vueTerminal = new Vue({
    ...
    `,
    data: {
        user: "visitor@illogicalfallacy.ml",
        directory: "/~",
        suffix: "$",
        history: new Array(),
        historyIndex: 0,
...
$ cat`,
            "clear": "exec clear",
            "ls": "nananjajeans.txt blog.txt cat.txt \n",
            "cat": "Specify the file you want to open... \n",
            "cat nananjajeans.txt": `\nHi!  In my life, as I was making my way, I always asked the question, 'Am I the most powerful person in the room?' And the answer needed to be 'Yes'.\n`,
            "cat cat.txt": `
　 ／l、     Meow :3
ﾞ（ﾟ､ ｡ ７
　 l、ﾞ ~ヽ
...
`,
            "cat blog.txt": `
I will add something soon! Comeback on a later date!
`
        }
    },
    computed: {
